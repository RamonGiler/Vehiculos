...
<!-- Mirrored from uselooper.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Jan 2024 02:56:17 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
                ...
                <li class="menu-item has-child">
                  <a href="#" class="menu-link"><span class="menu-icon far fa-file"></span> <span class="menu-text">App Pages</span> </a> <!-- child menu -->
                  <ul class="menu">
                    <li class="menu-item">
                      <a href="{{url('/marcas')}}"  class="menu-link">MARCAS</a>
                    </li>
                    <li class="menu-item">
                      <a href="{{url('/modelos')}}"class="menu-link">MODELOS</a>
                    </li>
                    <li class="menu-item">
                      <a href="{{url('/colores')}}" class="menu-link">COLORES</a>
                    </li>
                    <li class="menu-item">
                      <a href="{{url('/vehiculos')}}" class="menu-link">VEHICULO</a>
                    </li>
                  </ul><!-- /child menu -->
                </li><!-- /.menu-item -->
              </ul><!-- /.menu -->
